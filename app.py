...
def donation_submit():
  ...
  # Create new charity if that name did not already exist
...
# Helper Function to create new charity
def create_new_charity(donation):
  ...
  ### Parameters
  @donation: donation object that includes charity_name, donation_amount, and date_donated

  ### Returns
  None. inserts a new charity if it didn't exist
   """
